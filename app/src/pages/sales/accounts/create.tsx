        ...
        <div className="flex flex-col pb-10">
                ...
                <CardContent className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-x-10 gap-y-4">
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Account Owner</label>
            ...
            <Card className="mt-6 border border-slate-200 rounded-3xl">
                ...
                <CardContent className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-x-10 gap-y-4">
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Billing Street</label>
                            <Input className="py-5 flex-1" />
                        </div>
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Billing City</label>
                            <Input className="py-5 flex-1" />
                        </div>
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Billing State</label>
                            <Input className="py-5 flex-1" />
                        </div>
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Billing Zip</label>
                            <Input className="py-5 flex-1" />
                        </div>
                        <div className="flex items-center gap-4">
                            <label className="text-sm font-medium text-slate-600 w-32">Billing Country</label>
                            <Input className="py-5 flex-1" />
                        </div>
                    </div>
                </CardContent>
